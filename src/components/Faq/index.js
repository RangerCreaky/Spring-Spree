    ...
    <FaqContainer>
      ...
      <QueryContainer>
        ...
        <Query>
          ...
          <p>
            The fest is celebrated for three consecutive days from April 8 to
            April 10 2022.
          </p>
        </Query>
        <Query>
        ...
        <Query>
          ...
          <p>
            ...
            <a href="https://springspree22.in">springspree22.in</a>) by filling
        ...
        <Query>
          ...
          <p>
            ...
            participate in Spring Spree 2022.
          </p>
        </Query>
        ...
        <Query>
          <h2>
            ...
            nights of Spring Spree 2022?
          </h2>
          <p>
            {" "}
            Day-1 : <strong>Sriram chandra and ram miriyala </strong>{" "}
          </p>
          <p>
            {" "}
            Day-2 : <strong>Underground authority and sunburn (dj) </strong>
          </p>
          <p>
            {" "}
            Day-3 : <strong>Darshan raval </strong>{" "}
          </p>
          <p>
            Follow us on (
            <a href="https://www.facebook.com/nitw.springspree">Facebook</a> and{" "}
            <a href="https://www.instagram.com/springspree_nitw">Instagram</a>)
            for more updates.
          </p>
        </Query>
      </QueryContainer>
